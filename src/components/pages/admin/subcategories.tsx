...
import { Plus, Search, Layers, Package, TrendingUp, Eye } from "lucide-react"
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">All products categorized</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold">Hot Coffee</div>
            <p className="text-xs text-muted-foreground">25 products</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="text-center py-12 text-muted-foreground">
            ...
            <h3 className="text-lg font-medium mb-2">Sub-categories Coming Soon</h3>
            <p>Sub-category management will be available in the next update.</p>
          </div>
        </CardContent>
      </Card>
    </div>
