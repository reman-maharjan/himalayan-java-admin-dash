...
import { Plus, Search, Tags, Package, TrendingUp, Eye } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">Pastries</div>
            <p className="text-xs text-muted-foreground">32 products</p>
          </CardContent>
        </Card>
      </div>
